  ...
  return (
    ...
    >
      <div className="max-w-2xl text-center text-white">
        <p className="text-xs md:text-sm font-bold uppercase mb-2 md:mb-4 text-gray-300">newsfeed</p>
        <h2 className="text-3xl md:text-5xl font-medium mb-2 md:mb-4">Join Our Newsletter</h2>
